...
import { Table, Button, Tag, Tooltip, Popconfirm, Drawer, Image } from "antd";
import {
  DeleteTwoTone,
  EditTwoTone,
  ExportOutlined,
...
const TableBook: React.FC = () => {
  const [books, setBooks] = useState<Book[]>([
    {
      ...
      name: "Tiệm Sách Của Nàng - Tặng Kèm Bookmark Photostrip + Sổ Tay Màu Ngẫu Nhiên",
      category: "Nhân Vật - Bài Học Kinh Doanh Nhân Vật - Bài Học Kinh Doanh",
  ...
  const columns: ColumnsType<Book> = [
    ...
    },
    {
      ...
      render: (name) => (
                <div className="w-[250px] line-clamp-1">
                    <p>{name}</p>
                </div>
            ),
    },
    ...
    },
    {
      ...
      dataIndex: "oldPrice",
       align: "center",
      render: (oldPrice) =>(
        <span>{Intl.NumberFormat("vi-VN").format(oldPrice)} đ</span>
            ...
            <div className="w-full flex text-caption">
              ...
              <div className="flex-1 flex">
               ...
               Giá Cũ
                ...
                <span>
                  {Intl.NumberFormat("vi-VN").format(selectedBook.oldPrice)} đ
                </span>
                 )}
