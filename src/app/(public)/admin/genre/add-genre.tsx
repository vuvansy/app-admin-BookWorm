...
interface AddGenreProps {
  visible: boolean;
  onAdd: (newGenre: IGenre) => void;
  onClose: () => void;
}

const AddGenre: React.FC<AddGenreProps> = ({ visible, onAdd, onClose }) => {
      ...
      <Form form={form} layout="vertical" className="space-y-4">
        ...
        >
          <Upload
            ...
            maxCount={1} // Chỉ cho phép upload 1 ảnh duy nhất
            multiple={false}
            customRequest={customRequest} // Sử dụng hàm customRequest đã định nghĩa ở trên
